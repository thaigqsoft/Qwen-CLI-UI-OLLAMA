...
import { createBrowserRouter, RouterProvider, Routes, Route, useNavigate, useParams, Outlet } from 'react-router-dom';
...
function AppContent() {
  ...
  const { updateAvailable, latestVersion, currentVersion } = useVersionCheck('cruzyjapan', 'Qwen-CLI-UI');
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-full max-w-md mx-4 p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              Run this command in your Qwen CLI UI directory to update to the latest version.
            </p>
          </div>
...
// Layout component that wraps the app with providers
function AppLayout() {
  return (
    <ErrorBoundary>
      <ThemeProvider>
